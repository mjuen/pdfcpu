...
[![Test](https://github.com/mjuen/pdfcpu/workflows/Test/badge.svg)](https://github.com/mjuen/pdfcpu/actions)
...
[![GoDoc](https://godoc.org/github.com/mjuen/pdfcpu?status.svg)](https://pkg.go.dev/github.com/mjuen/pdfcpu)
[![Go Report Card](https://goreportcard.com/badge/github.com/mjuen/pdfcpu)](https://goreportcard.com/report/github.com/mjuen/pdfcpu)
[![Hex.pm](https://img.shields.io/hexpm/l/plug.svg)](https://opensource.org/licenses/Apache-2.0)
[![Latest release](https://img.shields.io/github/release/pdfcpu/pdfcpu.svg)](https://github.com/mjuen/pdfcpu/releases)
...
* For API examples of all pdfcpu operations please refer to [GoDoc](https://pkg.go.dev/github.com/mjuen/pdfcpu/pkg/api).

### GoDoc

* [pdfcpu package](https://pkg.go.dev/github.com/mjuen/pdfcpu)
* [pdfcpu API](https://pkg.go.dev/github.com/mjuen/pdfcpu/pkg/api)
* [pdfcpu CLI](https://pkg.go.dev/github.com/mjuen/pdfcpu/pkg/cli)
...
### Download
Get the latest binary [here](https://github.com/mjuen/pdfcpu/releases).


### Using Go Modules

```
$ git clone https://github.com/mjuen/pdfcpu
...
```
$ go install github.com/mjuen/pdfcpu/cmd/pdfcpu@latest
```
...
* Please [create](https://github.com/mjuen/pdfcpu/issues/new/choose) an issue if you find a bug or want to propose a change.
* Feature requests - always welcome!
* Bug fixes - always welcome!
* PRs - let's [discuss](https://github.com/mjuen/pdfcpu/discussions) first or [create](https://github.com/mjuen/pdfcpu/issues/new/choose) an issue.
* pdfcpu is stable but still *Alpha* and occasionally undergoing heavy changes.

### How

* The pdfcpu [discussion board](https://github.com/mjuen/pdfcpu/discussions) is open! Please engage in any form helpful for the community.
